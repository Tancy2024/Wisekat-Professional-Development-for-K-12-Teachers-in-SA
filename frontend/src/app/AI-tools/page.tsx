...
const tools = [
  ...
  },
  {
    ...
    description: "Summarize long text into key points with one click.",
  ...
  {
    title: "Chat with GPT",
    description: "Ask any question and get intelligent responses from GPT.",
    icon: "/icons/chat.png",
  },
];
      ...
      <section className='w-full bg-white min-h-screen flex items-center'>
        <div className='max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between gap-20'>
          ...
          <div className='md:w-1/2 space-y-8'>
            <h2 className='text-4xl font-bold'>AI tools for teaching</h2>
            <p className='text-gray-600 leading-relaxed text-base'>
              Use cutting-edge AI tools to simplify lesson planning, content
              ...
              <div className='space-y-4'>
                ...
                {summary && (
                  <div className='mt-4'>
                    ...
                    <p className='border p-4 bg-gray-50 rounded-md whitespace-pre-wrap'>
                      {summary}
                    </p>
                  </div>
                )}
